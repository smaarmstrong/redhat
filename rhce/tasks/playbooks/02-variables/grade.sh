...
cd /opt/rhce/variables 2>/dev/null || true
...
check "target file exists" test -f /opt/rhce/vars/hello.txt
check_eval "file content is the message" 'grep -qx "hello from ansible" /opt/rhce/vars/hello.txt'
